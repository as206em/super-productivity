...
App Features can show or hide optional app areas, including Planner, Schedule,
Boards, Search, Habits, and the Priority page.
...
#### global-settings.Capacity

Capacity settings define visual load warnings for planner days and sprint pages.
The weekday, weekend, and sprint capacities are duration values. A capacity of
`0` disables the warning for that scope. These settings do not block planning or
moving tasks.
