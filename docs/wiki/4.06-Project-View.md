...
When you view a project, you see all tasks that belong to it. Task rows can show the task's project as a badge, alongside other contextual badges such as section, sprint, and tag metadata. When you view a tag, you see tasks from multiple projects that have that tag, so the project badge helps identify each task's home project.
