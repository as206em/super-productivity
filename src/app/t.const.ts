const T = {
  ...
  SPRINT: {
    ADD_TO_CURRENT: 'SPRINT.ADD_TO_CURRENT',
    ADD_TO_NEXT: 'SPRINT.ADD_TO_NEXT',
    ADD_TO_SPRINT: 'SPRINT.ADD_TO_SPRINT',
    CLOSE: 'SPRINT.CLOSE',
    CLOSE_CONFIRM_MSG: 'SPRINT.CLOSE_CONFIRM_MSG',
    CLOSE_CONFIRM_OK: 'SPRINT.CLOSE_CONFIRM_OK',
    CLOSE_CONFIRM_TITLE: 'SPRINT.CLOSE_CONFIRM_TITLE',
    CURRENT: 'SPRINT.CURRENT',
    NEXT: 'SPRINT.NEXT',
    REMOVE_FROM_SPRINT: 'SPRINT.REMOVE_FROM_SPRINT',
  },
  CONFIRM: {
  ...
  F: {
    ...
    PLANNER: {
      ...
      PLAN_VIEW: {
        SCHEDULED: 'F.PLANNER.PLAN_VIEW.SCHEDULED',
    ...
    PRIORITY: {
      GROUP_BY: 'F.PRIORITY.GROUP_BY',
      GROUP_NONE: 'F.PRIORITY.GROUP_NONE',
      GROUP_PROJECT: 'F.PRIORITY.GROUP_PROJECT',
      GROUP_PROJECT_SECTION: 'F.PRIORITY.GROUP_PROJECT_SECTION',
      SHOW_INCOMPLETE: 'F.PRIORITY.SHOW_INCOMPLETE',
    },
    POMODORO: {
    ...
    PROJECT: {
      ...
      FORM_BASIC: {
        L_DEADLINE: 'F.PROJECT.FORM_BASIC.L_DEADLINE',
        ...
        L_VALUE: 'F.PROJECT.FORM_BASIC.L_VALUE',
    ...
    TASK: {
      ...
      CMP: {
        ...
        CLEAR_EFFORT: 'F.TASK.CMP.CLEAR_EFFORT',
        CLEAR_VALUE: 'F.TASK.CMP.CLEAR_VALUE',
        ...
        SCORE: 'F.TASK.CMP.SCORE',
        SELECT: 'F.TASK.CMP.SELECT',
        ...
        VALUE: 'F.TASK.CMP.VALUE',
      },
      D_CONFIRM_DELETE: {
        MSG: 'F.TASK.D_CONFIRM_DELETE.MSG',
        MSG_MULTIPLE: 'F.TASK.D_CONFIRM_DELETE.MSG_MULTIPLE',
    ...
    TASK_VIEW: {
      CUSTOMIZER: {
        ...
        SORT_SCORE: 'F.TASK_VIEW.CUSTOMIZER.SORT_SCORE',
  ...
  GCF: {
    CAPACITY: {
      HELP: 'GCF.CAPACITY.HELP',
      SPRINT_CAPACITY: 'GCF.CAPACITY.SPRINT_CAPACITY',
      TITLE: 'GCF.CAPACITY.TITLE',
      WEEKDAY_CAPACITY: 'GCF.CAPACITY.WEEKDAY_CAPACITY',
      WEEKEND_CAPACITY: 'GCF.CAPACITY.WEEKEND_CAPACITY',
      ZERO_DISABLES: 'GCF.CAPACITY.ZERO_DISABLES',
    },
    APP_FEATURES: {
      ...
      PRIORITY_PAGE: 'GCF.APP_FEATURES.PRIORITY_PAGE',
  ...
  MH: {
    ...
    FILTER: 'MH.FILTER',
    FOCUS: 'MH.FOCUS',
    TOGGLE_FOCUS_MODE: 'MH.TOGGLE_FOCUS_MODE',
  ...
  WW: {
    N_SELECTED: 'WW.N_SELECTED',
    SELECTION_ADD_TODAY: 'WW.SELECTION_ADD_TODAY',
    SELECTION_DELETE: 'WW.SELECTION_DELETE',
    SELECTION_DONE: 'WW.SELECTION_DONE',
    SELECTION_REMOVE_TODAY: 'WW.SELECTION_REMOVE_TODAY',
    SELECTION_CLEAR: 'WW.SELECTION_CLEAR',
    SELECTION_MOVE_TO_PROJECT: 'WW.SELECTION_MOVE_TO_PROJECT',
    DENSITY_ROWS: 'WW.DENSITY_ROWS',
    DENSITY_CARDS: 'WW.DENSITY_CARDS',
    DENSITY_COMPACT: 'WW.DENSITY_COMPACT',
    NEW_TASK: 'WW.NEW_TASK',
    ADD_MORE: 'WW.ADD_MORE',
    ADD_SCHEDULED_FOR_TOMORROW: 'WW.ADD_SCHEDULED_FOR_TOMORROW',
    ADD_SECTION_TITLE: 'WW.ADD_SECTION_TITLE',
    SECTION_DEADLINE: 'WW.SECTION_DEADLINE',
    SECTION_OPTIONS: 'WW.SECTION_OPTIONS',
    SECTION_VALUE: 'WW.SECTION_VALUE',
